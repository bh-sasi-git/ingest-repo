...
common_task = CommonTask(dag_id='ingestion_up1', dag_params={})
lineage_task = LineageTask(dag_id='ingestion_up1', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 477,
            'flow_name': 'ingestion_up1',
            'flow_key': 'ingestion_up1',
            'bh_project_id': 300,
