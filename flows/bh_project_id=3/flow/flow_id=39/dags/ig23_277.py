...
common_task = CommonTask(dag_id='ig23_277', dag_params={})
lineage_task = LineageTask(dag_id='ig23_277', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ig23_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=110/ig23.json",
                "databricks",
    ...
    run_pipelines_ig23 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ig23',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_user_data_direct_map_load_260519_dc03_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=200/silver_raw_user_data_direct_map_load_260519_dc03.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_user_data_direct_map_load_260519_dc03 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_user_data_direct_map_load_260519_dc03',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_pipelines_ig23
    run_pipelines_ig23 >> run_pipelines_silver_raw_user_data_direct_map_load_260519_dc03
    create_compute >> run_pipelines_silver_raw_user_data_direct_map_load_260519_dc03
    run_pipelines_silver_raw_user_data_direct_map_load_260519_dc03 >> archive_processed_files
