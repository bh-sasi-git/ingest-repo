...
common_task = CommonTask(dag_id='ig24_278', dag_params={})
lineage_task = LineageTask(dag_id='ig24_278', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_ig24_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=201/ig24.json",
                "databricks",
    ...
    run_pipelines_ig24 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_ig24',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_user_data_direct_map_load_260519_dc59_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=202/silver_raw_user_data_direct_map_load_260519_dc59.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_pipelines_silver_raw_user_data_direct_map_load_260519_dc59 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_user_data_direct_map_load_260519_dc59',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    _archive_params = {
        ...
        "files": [
            {
                "key": "mock_data/user_data.csv",
                "base_name": "user_data.csv",
                "source_name": "user_data",
                "relative_key": "user_data.csv",
                "size_bytes": 50002
            }
        ],
        "source_prefix": "",
        "archive_prefix": "Archive/mock_data",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-nblosa",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_ig24
    run_pipelines_ig24 >> run_pipelines_silver_raw_user_data_direct_map_load_260519_dc59
    create_compute >> run_pipelines_silver_raw_user_data_direct_map_load_260519_dc59
    run_pipelines_silver_raw_user_data_direct_map_load_260519_dc59 >> archive_processed_files
