...
common_task = CommonTask(dag_id='test1_29_52', dag_params={})
lineage_task = LineageTask(dag_id='test1_29_52', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_test1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=13/test1.json",
                "databricks",
    ...
    run_jobs_test1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_test1',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_records_to_test_tables_map_260601_4147_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=14/silver_raw_records_to_test_tables_map_260601_4147.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_records_to_test_tables_map_260601_4147 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_records_to_test_tables_map_260601_4147',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_test1
    run_jobs_test1 >> run_jobs_silver_raw_records_to_test_tables_map_260601_4147
    create_compute >> run_jobs_silver_raw_records_to_test_tables_map_260601_4147
    run_jobs_silver_raw_records_to_test_tables_map_260601_4147 >> delete_compute
