...
common_task = CommonTask(dag_id='kiranu2_32_53', dag_params={})
lineage_task = LineageTask(dag_id='kiranu2_32_53', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_kiranu2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/pipelines/bh_project_id=3/pipeline/pipeline_id=15/kiranu2.json",
                "databricks",
    ...
    run_jobs_kiranu2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_kiranu2',
    ...
    create_compute >> run_jobs_kiranu2
    run_jobs_kiranu2 >> delete_compute
