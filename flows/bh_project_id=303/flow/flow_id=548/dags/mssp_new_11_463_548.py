...
common_task = CommonTask(dag_id='mssp_new_11_463_548', dag_params={})
lineage_task = LineageTask(dag_id='mssp_new_11_463_548', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 548,
            'flow_name': 'MSSP_NEW_11_463',
            'flow_key': 'mssp_new_11_463',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_mssp_new_11_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=922/mssp_new_11.json",
                "databricks",
    ...
    run_jobs_mssp_new_11 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_mssp_new_11',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_mssp_to_claims_direct_map_load_260530_e615_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=923/silver_raw_mssp_to_claims_direct_map_load_260530_e615.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_mssp_to_claims_direct_map_load_260530_e615 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_mssp_to_claims_direct_map_load_260530_e615',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_mssp_new_11
    run_jobs_mssp_new_11 >> run_jobs_silver_raw_mssp_to_claims_direct_map_load_260530_e615
    create_compute >> run_jobs_silver_raw_mssp_to_claims_direct_map_load_260530_e615
    run_jobs_silver_raw_mssp_to_claims_direct_map_load_260530_e615 >> delete_compute
