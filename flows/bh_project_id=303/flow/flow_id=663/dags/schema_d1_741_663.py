...
common_task = CommonTask(dag_id='schema_d1_741_663', dag_params={})
lineage_task = LineageTask(dag_id='schema_d1_741_663', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 663,
            'flow_name': 'schema_d1_741',
            'flow_key': 'schema_d1_741',
            'bh_project_id': 303,
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/663/schema_d1_741/",
                    "spark.flow.id": "663",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1244",
                "spark.pipeline.name": "schema_d1"
            }
        },
        "ingestion_group_id": 741,
        "flow_id": 663,
        ...
        "pipeline_name": "schema_d1",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/663/schema_d1_741/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
    ...
    run_pipelines_schema_d1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_schema_d1',
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1245",
                "spark.pipeline.name": "silver_raw_employees_to_test_table_load_260713_b41a"
            }
        },
        "ingestion_group_id": 741,
        "flow_id": 663,
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_employees_to_test_table_load_260713_b41a",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/663/schema_d1_741/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
        "metrics_storage_secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblobconn",
        "keycloak_secret_name": "bh-dev-westus3-kv-key-scope/bh-app-muthukumar-databricks-keycloak-321-v1-secrets",
        ...
        "cloud_provider": "databricks",
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "silver_raw_employees_to_test_table_load_260713_b41a",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_employees_to_test_table_load_260713_b41a = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_employees_to_test_table_load_260713_b41a',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_schema_d1
    run_pipelines_schema_d1 >> run_pipelines_silver_raw_employees_to_test_table_load_260713_b41a
    create_compute >> run_pipelines_silver_raw_employees_to_test_table_load_260713_b41a
    run_pipelines_silver_raw_employees_to_test_table_load_260713_b41a >> archive_processed_files
