...
common_task = CommonTask(dag_id='testing_schema2_608_611', dag_params={})
lineage_task = LineageTask(dag_id='testing_schema2_608_611', dag_params={})
...
with DAG(
    dag_id='testing_schema2_608_611',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 611,
            'flow_name': 'testing_schema2_608',
            'flow_key': 'testing_schema2_608',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_testing_schema2_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=1107/testing_schema2.json",
                "databricks",
        ...
        "flow_id": 611,
        "pipeline_id": 1107,
        "pipeline_name": "testing_schema2",
        "compute_xcom_key": "return_value"
    }
    run_jobs_testing_schema2 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_testing_schema2',
    ...
    create_compute >> run_jobs_testing_schema2
    run_jobs_testing_schema2 >> delete_compute
