...
common_task = CommonTask(dag_id='test_ods99_645_624', dag_params={})
lineage_task = LineageTask(dag_id='test_ods99_645_624', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 624,
            'flow_name': 'test_ods99_645',
            'flow_key': 'test_ods99_645',
            'bh_project_id': 303,
    ...
    _validate_params = {
        ...
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "testing/rejected",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_test_ods99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=1137/test_ods99.json",
                "databricks",
    ...
    run_pipelines_test_ods99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_test_ods99',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_pipelines_silver_raw_employees_direct_map_260630_233b_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=1138/silver_raw_employees_direct_map_260630_233b.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_employees_direct_map_260630_233b",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_employees_direct_map_260630_233b = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_employees_direct_map_260630_233b',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/testing",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblobconn",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_test_ods99
    run_pipelines_test_ods99 >> run_pipelines_silver_raw_employees_direct_map_260630_233b
    create_compute >> run_pipelines_silver_raw_employees_direct_map_260630_233b
    run_pipelines_silver_raw_employees_direct_map_260630_233b >> run_pipelines_testing_ods
