...
common_task = CommonTask(dag_id='schema_d99_746_664', dag_params={})
lineage_task = LineageTask(dag_id='schema_d99_746_664', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 664,
            'flow_name': 'schema_d99_746',
            'flow_key': 'schema_d99_746',
            'bh_project_id': 303,
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/664/schema_d99_746/",
                    "spark.flow.id": "664",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "spark_conf": {
                "spark.pipeline.id": "1248",
                "spark.pipeline.name": "schema_d99"
            }
        },
        "ingestion_group_id": 746,
        "flow_id": 664,
        ...
        "pipeline_name": "schema_d99",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/664/schema_d99_746/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
    ...
    run_pipelines_schema_d99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_schema_d99',
    ...
    create_compute >> run_pipelines_schema_d99
    run_pipelines_schema_d99 >> archive_processed_files
