...
common_task = CommonTask(dag_id='test5_476_552', dag_params={})
lineage_task = LineageTask(dag_id='test5_476_552', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_test5_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=934/test5.json",
                "databricks",
    ...
    run_jobs_test5 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_test5',
    ...
    create_compute >> run_jobs_test5
    run_jobs_test5 >> delete_compute
