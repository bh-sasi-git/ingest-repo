...
common_task = CommonTask(dag_id='cclf_s1_413', dag_params={})
lineage_task = LineageTask(dag_id='cclf_s1_413', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 522,
            'flow_name': 'CCLF_S1_413',
            'flow_key': 'cclf_s1_413',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_cclf_s1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=838/cclf_s1.json",
                "databricks",
    ...
    run_jobs_cclf_s1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_cclf_s1',
    ...
    create_compute >> run_jobs_cclf_s1
    run_jobs_cclf_s1 >> delete_compute
