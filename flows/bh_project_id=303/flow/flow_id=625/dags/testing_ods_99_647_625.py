...
common_task = CommonTask(dag_id='testing_ods_99_647_625', dag_params={})
lineage_task = LineageTask(dag_id='testing_ods_99_647_625', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 625,
            'flow_name': 'testing_ods_99_647',
            'flow_key': 'testing_ods_99_647',
            'bh_project_id': 303,
    ...
    run_pipelines_testing_ods_99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_testing_ods_99',
    ...
    run_pipelines_silver_raw_employees_to_target_map_260630_6a88 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_employees_to_target_map_260630_6a88',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    create_compute >> run_pipelines_testing_ods_99
    run_pipelines_testing_ods_99 >> run_pipelines_silver_raw_employees_to_target_map_260630_6a88
    create_compute >> run_pipelines_silver_raw_employees_to_target_map_260630_6a88
    run_pipelines_silver_raw_employees_to_target_map_260630_6a88 >> run_pipelines_testing_ods
