...
common_task = CommonTask(dag_id='test_k9_491_560', dag_params={})
lineage_task = LineageTask(dag_id='test_k9_491_560', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 560,
            'flow_name': 'TEST_k9_491',
            'flow_key': 'test_k9_491',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_test_k9_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=961/test_k9.json",
                "databricks",
    ...
    run_jobs_test_k9 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_test_k9',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_d0284_to_claim_tables_load_260602_65d3_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=963/silver_raw_d0284_to_claim_tables_load_260602_65d3.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_d0284_to_claim_tables_load_260602_65d3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_d0284_to_claim_tables_load_260602_65d3',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_test_k9
    run_jobs_test_k9 >> run_jobs_silver_raw_d0284_to_claim_tables_load_260602_65d3
    create_compute >> run_jobs_silver_raw_d0284_to_claim_tables_load_260602_65d3
    run_jobs_silver_raw_d0284_to_claim_tables_load_260602_65d3 >> delete_compute
