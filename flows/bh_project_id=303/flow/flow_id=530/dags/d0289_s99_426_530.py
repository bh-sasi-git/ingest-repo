...
common_task = CommonTask(dag_id='d0289_s99_426_530', dag_params={})
lineage_task = LineageTask(dag_id='d0289_s99_426_530', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 530,
            'flow_name': 'D0289_s99_426',
            'flow_key': 'd0289_s99_426',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_d0289_s99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=853/d0289_s99.json",
                "databricks",
    ...
    run_jobs_d0289_s99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_d0289_s99',
    ...
    create_compute >> run_jobs_d0289_s99
    run_jobs_d0289_s99 >> delete_compute
