...
common_task = CommonTask(dag_id='d0284_d3_406', dag_params={})
lineage_task = LineageTask(dag_id='d0284_d3_406', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 518,
            'flow_name': 'D0284_d3_406',
            'flow_key': 'd0284_d3_406',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_d0284_d3_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=824/d0284_d3.json",
                "databricks",
    ...
    run_jobs_d0284_d3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_d0284_d3',
    ...
    create_compute >> run_jobs_d0284_d3
    run_jobs_d0284_d3 >> delete_compute
