...
common_task = CommonTask(dag_id='testing_schema3_609_612', dag_params={})
lineage_task = LineageTask(dag_id='testing_schema3_609_612', dag_params={})
...
with DAG(
    dag_id='testing_schema3_609_612',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 612,
            'flow_name': 'testing_schema3_609',
            'flow_key': 'testing_schema3_609',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_testing_schema3_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=1108/testing_schema3.json",
                "databricks",
        ...
        "flow_id": 612,
        "pipeline_id": 1108,
        "pipeline_name": "testing_schema3",
        "compute_xcom_key": "return_value"
    }
    run_jobs_testing_schema3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_testing_schema3',
    ...
    create_compute >> run_jobs_testing_schema3
    run_jobs_testing_schema3 >> delete_compute
