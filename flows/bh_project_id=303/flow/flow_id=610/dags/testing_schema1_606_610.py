...
common_task = CommonTask(dag_id='testing_schema1_606_610', dag_params={})
lineage_task = LineageTask(dag_id='testing_schema1_606_610', dag_params={})
...
with DAG(
    dag_id='testing_schema1_606_610',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 610,
            'flow_name': 'testing_schema1_606',
            'flow_key': 'testing_schema1_606',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "flow_id": 610,
        "pipeline_id": 1106,
        "pipeline_name": "testing_schema1",
        "compute_xcom_key": "return_value"
    }
    run_jobs_testing_schema1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_testing_schema1',
    ...
    create_compute >> run_jobs_testing_schema1
    run_jobs_testing_schema1 >> delete_compute
