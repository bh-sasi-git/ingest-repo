...
common_task = CommonTask(dag_id='test_ods3_644_623', dag_params={})
lineage_task = LineageTask(dag_id='test_ods3_644_623', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 623,
            'flow_name': 'test_ods3_644',
            'flow_key': 'test_ods3_644',
            'bh_project_id': 303,
            'project_name': 'Project_s1',
    ...
    _validate_params = {
        ...
        "source_prefix": "cclf_testing",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblobconn",
        "filename_regex": None,
        "min_bytes": 1,
        "max_bytes": None,
        "min_files": 1,
        "max_files": None,
        "quarantine_prefix": "cclf_testing/rejected",
        "fail_on_invalid": True,
        "sources": [
            {
                "source_name": "p_d0284_aco_zc1y26_d260501",
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC1Y26.D260501.dat",
            ...
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC2Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC3Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC4Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC5Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC6Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC7Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC8Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZC9Y26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZCAY26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
            },
            {
                ...
                "prefix": "cclf_testing",
                "filename_regex": "P.D0284.ACO.ZCBY26.D260501.dat",
                "ignore_subfolders": True,
                "is_required": True,
                "min_bytes": 10,
                "min_files": 1
    ...
    run_pipelines_test_ods3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_test_ods3',
    ...
    _submit_params = {
        ...
        "validate_inbound_task_id": "validate_inbound_files",
        "facts_source": "databricks",
        "pipeline_name": "silver_raw_d0284_claims_to_silver_raw_load_260630_fca9",
        "compute_xcom_key": "return_value",
        "valid_files": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='valid_files') }}",
        "batch_id": "{{ task_instance.xcom_pull(task_ids='validate_inbound_files', key='batch_id') }}"
    }
    run_pipelines_silver_raw_d0284_claims_to_silver_raw_load_260630_fca9 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_silver_raw_d0284_claims_to_silver_raw_load_260630_fca9',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    run_pipelines_testing_ods = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_testing_ods',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=feed_control_callbacks.submit_job_success_callback,
        on_failure_callback=feed_control_callbacks.submit_job_failure_callback,
    ...
    _archive_params = {
        "bucket_name": "my-test-bucket",
        "source_prefix": "",
        "archive_prefix": "Archive/cclf_testing",
        "cloud_type": "databricks",
        "airflow_connection_id": "databricks_default",
        "secret_name": "bh-dev-westus3-kv-key-scope/bh-azureblob-azureblobconn",
        "delete_source": True,
    ...
    create_compute >> run_pipelines_test_ods3
    run_pipelines_test_ods3 >> run_pipelines_silver_raw_d0284_claims_to_silver_raw_load_260630_fca9
    create_compute >> run_pipelines_silver_raw_d0284_claims_to_silver_raw_load_260630_fca9
    run_pipelines_silver_raw_d0284_claims_to_silver_raw_load_260630_fca9 >> run_pipelines_testing_ods
    create_compute >> run_pipelines_testing_ods
    run_pipelines_testing_ods >> archive_processed_files
