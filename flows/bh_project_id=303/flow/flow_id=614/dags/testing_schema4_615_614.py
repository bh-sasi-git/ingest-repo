...
common_task = CommonTask(dag_id='testing_schema4_615_614', dag_params={})
lineage_task = LineageTask(dag_id='testing_schema4_615_614', dag_params={})
...
with DAG(
    dag_id='testing_schema4_615_614',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 614,
            'flow_name': 'testing_schema4_615',
            'flow_key': 'testing_schema4_615',
            'bh_project_id': 303,
    ...
    _validate_params = {
        ...
        "sources": [
            {
                "source_name": "employees_1",
                "prefix": "testing",
                "filename_regex": "employees_1.csv",
    ...
    run_pipelines_testing_schema4 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_testing_schema4',
    ...
    create_compute >> run_pipelines_testing_schema4
    run_pipelines_testing_schema4 >> archive_processed_files
