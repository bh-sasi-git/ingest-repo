...
common_task = CommonTask(dag_id='test3_474_551', dag_params={})
lineage_task = LineageTask(dag_id='test3_474_551', dag_params={})
...
with DAG(
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_test3_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=932/test3.json",
                "databricks",
    ...
    run_jobs_test3 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_test3',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_tables_to_test_tables_id_name_map_260601_e7ca_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=933/silver_raw_tables_to_test_tables_id_name_map_260601_e7ca.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_tables_to_test_tables_id_name_map_260601_e7ca = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_tables_to_test_tables_id_name_map_260601_e7ca',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_test3
    run_jobs_test3 >> run_jobs_silver_raw_tables_to_test_tables_id_name_map_260601_e7ca
    create_compute >> run_jobs_silver_raw_tables_to_test_tables_id_name_map_260601_e7ca
    run_jobs_silver_raw_tables_to_test_tables_id_name_map_260601_e7ca >> delete_compute
