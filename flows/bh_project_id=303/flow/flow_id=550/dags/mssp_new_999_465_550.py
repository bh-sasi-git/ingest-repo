...
common_task = CommonTask(dag_id='mssp_new_999_465_550', dag_params={})
lineage_task = LineageTask(dag_id='mssp_new_999_465_550', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 550,
            'flow_name': 'MSSP_NEW_999_465',
            'flow_key': 'mssp_new_999_465',
            'bh_project_id': 303,
        ...
        payload = (
            {
                ...
                "bh_tags": [],
                "compute_config_name": "demo_config_01"
            }
        )
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_mssp_new_999_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=926/mssp_new_999.json",
                "databricks",
    ...
    run_jobs_mssp_new_999 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_mssp_new_999',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=927/silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_mssp_new_999
    run_jobs_mssp_new_999 >> run_jobs_silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55
    create_compute >> run_jobs_silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55
    run_jobs_silver_raw_bronze_to_silverraw_multi_table_load_260530_ed55 >> delete_compute
