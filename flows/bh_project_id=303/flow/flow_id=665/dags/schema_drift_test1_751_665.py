...
common_task = CommonTask(dag_id='schema_drift_test1_751_665', dag_params={})
lineage_task = LineageTask(dag_id='schema_drift_test1_751_665', dag_params={})
...
with DAG(
    dag_id='schema_drift_test1_751_665',
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 665,
            'flow_name': 'schema_drift_test1_751',
            'flow_key': 'schema_drift_test1_751',
            'bh_project_id': 303,
    ...
    _validate_params = {
        ...
        "control_schema": None,
        "feed_name": "schema_drift_test1",
        "feed_id": "schema_drift_test1"
    }
        ...
        payload = (
            {
                ...
                "spark_conf": {
                    ...
                    "spark.costanalyzer.outputDir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/665/schema_drift_test1_751/",
                    "spark.flow.id": "665",
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_pipelines_schema_drift_test1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=1258/schema_drift_test1.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ],
            "spark_conf": {
                "spark.pipeline.id": "1258",
                "spark.pipeline.name": "schema_drift_test1"
            }
        },
        "ingestion_group_id": 751,
        "flow_id": 665,
        ...
        "pipeline_name": "schema_drift_test1",
        "metrics_output_dir": "abfss://my-test-bucket@bhnprddwestus3rgbd5e.dfs.core.windows.net/spark-metrics/665/schema_drift_test1_751/",
        "blob_secrets_scope": "bh-dev-test-key-scope",
        ...
        "airflow_connection_id": "databricks_default",
        "pipeline_key": "schema_drift_test1",
    ...
    run_pipelines_schema_drift_test1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_pipelines_schema_drift_test1',
    ...
    create_compute >> run_pipelines_schema_drift_test1
    run_pipelines_schema_drift_test1 >> archive_processed_files
