...
common_task = CommonTask(dag_id='test_k7_480_555', dag_params={})
lineage_task = LineageTask(dag_id='test_k7_480_555', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 555,
            'flow_name': 'TEST_k7_480',
            'flow_key': 'test_k7_480',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_test_k7_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=944/test_k7.json",
                "databricks",
    ...
    run_jobs_test_k7 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_test_k7',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_tables_to_test_tables_map_260601_d993_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=945/silver_raw_tables_to_test_tables_map_260601_d993.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_tables_to_test_tables_map_260601_d993 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_tables_to_test_tables_map_260601_d993',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_test_k7
    run_jobs_test_k7 >> run_jobs_silver_raw_tables_to_test_tables_map_260601_d993
    create_compute >> run_jobs_silver_raw_tables_to_test_tables_map_260601_d993
    run_jobs_silver_raw_tables_to_test_tables_map_260601_d993 >> delete_compute
