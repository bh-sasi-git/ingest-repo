...
common_task = CommonTask(dag_id='d0284_new_99_455_540', dag_params={})
lineage_task = LineageTask(dag_id='d0284_new_99_455_540', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 540,
            'flow_name': 'D0284_NEW_99_455',
            'flow_key': 'd0284_new_99_455',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_d0284_new_99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=906/d0284_new_99.json",
                "databricks",
    ...
    run_jobs_d0284_new_99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_d0284_new_99',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_d0284_to_claim_tables_load_260529_67f5_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=907/silver_raw_d0284_to_claim_tables_load_260529_67f5.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_d0284_to_claim_tables_load_260529_67f5 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_d0284_to_claim_tables_load_260529_67f5',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_d0284_new_99
    run_jobs_d0284_new_99 >> run_jobs_silver_raw_d0284_to_claim_tables_load_260529_67f5
    create_compute >> run_jobs_silver_raw_d0284_to_claim_tables_load_260529_67f5
    run_jobs_silver_raw_d0284_to_claim_tables_load_260529_67f5 >> delete_compute
