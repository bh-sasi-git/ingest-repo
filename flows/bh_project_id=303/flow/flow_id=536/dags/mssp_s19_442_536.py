...
common_task = CommonTask(dag_id='mssp_s19_442_536', dag_params={})
lineage_task = LineageTask(dag_id='mssp_s19_442_536', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 536,
            'flow_name': 'MSSP_s19_442',
            'flow_key': 'mssp_s19_442',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_mssp_s19_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=880/mssp_s19.json",
                "databricks",
    ...
    run_jobs_mssp_s19 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_mssp_s19',
    ...
    create_compute >> run_jobs_mssp_s19
    run_jobs_mssp_s19 >> delete_compute
