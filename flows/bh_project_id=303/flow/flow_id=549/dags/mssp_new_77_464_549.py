...
common_task = CommonTask(dag_id='mssp_new_77_464_549', dag_params={})
lineage_task = LineageTask(dag_id='mssp_new_77_464_549', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 549,
            'flow_name': 'MSSP_NEW_77_464',
            'flow_key': 'mssp_new_77_464',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_mssp_new_77_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=924/mssp_new_77.json",
                "databricks",
    ...
    run_jobs_mssp_new_77 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_mssp_new_77',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_bronze_to_silverraw_claims_load_260530_3007_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=925/silver_raw_bronze_to_silverraw_claims_load_260530_3007.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_bronze_to_silverraw_claims_load_260530_3007 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_bronze_to_silverraw_claims_load_260530_3007',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_mssp_new_77
    run_jobs_mssp_new_77 >> run_jobs_silver_raw_bronze_to_silverraw_claims_load_260530_3007
    create_compute >> run_jobs_silver_raw_bronze_to_silverraw_claims_load_260530_3007
    run_jobs_silver_raw_bronze_to_silverraw_claims_load_260530_3007 >> delete_compute
