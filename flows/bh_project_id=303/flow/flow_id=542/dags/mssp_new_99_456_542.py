...
common_task = CommonTask(dag_id='mssp_new_99_456_542', dag_params={})
lineage_task = LineageTask(dag_id='mssp_new_99_456_542', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 542,
            'flow_name': 'MSSP_NEW_99_456',
            'flow_key': 'mssp_new_99_456',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_mssp_new_99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=908/mssp_new_99.json",
                "databricks",
    ...
    run_jobs_mssp_new_99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_mssp_new_99',
    ...
    _submit_params = {
        ...
        "job_config": {
            "job_type": "spark_python",
            "name": "{{ dag.dag_id }}_run_jobs_silver_raw_mssp_claims_to_claims_load_260529_61a9_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=909/silver_raw_mssp_claims_to_claims_load_260529_61a9.json",
                "databricks",
                "/Workspace/Shared/dev-utils/schemas"
            ]
        },
    ...
    run_jobs_silver_raw_mssp_claims_to_claims_load_260529_61a9 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_silver_raw_mssp_claims_to_claims_load_260529_61a9',
        python_callable=submit_job_to_cluster,
        params=_submit_params,
        on_success_callback=common_task.success_callback,
        on_failure_callback=common_task.failure_callback,
    ...
    create_compute >> run_jobs_mssp_new_99
    run_jobs_mssp_new_99 >> run_jobs_silver_raw_mssp_claims_to_claims_load_260529_61a9
    create_compute >> run_jobs_silver_raw_mssp_claims_to_claims_load_260529_61a9
    run_jobs_silver_raw_mssp_claims_to_claims_load_260529_61a9 >> delete_compute
