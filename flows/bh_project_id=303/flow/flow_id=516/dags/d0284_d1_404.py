...
common_task = CommonTask(dag_id='d0284_d1_404', dag_params={})
lineage_task = LineageTask(dag_id='d0284_d1_404', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 516,
            'flow_name': 'D0284_d1_404',
            'flow_key': 'd0284_d1_404',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_d0284_d1_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=822/d0284_d1.json",
                "databricks",
    ...
    run_jobs_d0284_d1 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_d0284_d1',
    ...
    create_compute >> run_jobs_d0284_d1
    run_jobs_d0284_d1 >> delete_compute
