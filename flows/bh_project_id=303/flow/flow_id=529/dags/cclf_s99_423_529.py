...
common_task = CommonTask(dag_id='cclf_s99_423_529', dag_params={})
lineage_task = LineageTask(dag_id='cclf_s99_423_529', dag_params={})
...
with DAG(
    ...
    start_flow_task = PythonOperator(
        ...
        params = {
            'flow_id': 529,
            'flow_name': 'CCLF_S99_423',
            'flow_key': 'cclf_s99_423',
            'bh_project_id': 303,
    ...
    _submit_params = {
        ...
        "job_config": {
            ...
            "name": "{{ dag.dag_id }}_run_jobs_cclf_s99_{{ ts_nodash }}",
            "python_file": "/Workspace/Shared/dev-utils/pipelines/main.py",
            "parameters": [
                "/Workspace/Shared/codespace/test/pipelines/bh_project_id=303/pipeline/pipeline_id=850/cclf_s99.json",
                "databricks",
    ...
    run_jobs_cclf_s99 = PythonOperator(
        pre_execute=common_task.pre_execute_callback,
        task_id='run_jobs_cclf_s99',
    ...
    create_compute >> run_jobs_cclf_s99
    run_jobs_cclf_s99 >> delete_compute
